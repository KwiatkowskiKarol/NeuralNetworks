...
model = tf.keras.Sequential([
    ...
    tf.keras.layers.Dense(10, activation=tf.nn.relu, name='fc3'),
    tf.keras.layers.Dense(10, activation=tf.nn.relu, name='fc4'),
    tf.keras.layers.Dense(10, activation=tf.nn.relu, name='fc5'),
    tf.keras.layers.Dense(10, activation=tf.nn.relu, name='fc6'),
